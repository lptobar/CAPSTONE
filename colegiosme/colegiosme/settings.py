...
SECRET_KEY = 'django-insecure-u6uld!2rn_njdp74fh64k!n!m8j4v4etumf^pkrxtl0k7$)_w)'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.Mensaje_no_leidos',
                'core.context_processors.contador_contactos_sin_respuesta',
            ],
        },
    },
]
