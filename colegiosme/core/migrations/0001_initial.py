    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_mensaje_padre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='principal', to='core.estadomensaje')),
                ('estado_mensaje_respuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='respuesta', to='core.estadomensaje')),
            ],
        ),
        migrations.CreateModel(
            name='Matricula',
        ...
        migrations.AddField(
            model_name='estadomensaje',
            name='mensaje',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estados', to='core.mensaje'),
        ),
        migrations.CreateModel(
            name='Apoderado',
            fields=[
